...
var_a <- 1:12                                 ## added
var_b <- rep(c("Con","LowN","HighN"),each=4)  ## added
var_c <- runif(12)                            ## added
d_frame <- data.frame(var_a,var_b,var_c)      ## added
...
zd[complete.cases(zd)] # clean them out     ## fixed
